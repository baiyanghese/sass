module Sass::Script::Value
  ...
  class Color < Base
    ...
    def to_s(opts = {})
      return smallest if Thread.current.thread_variable_get(:style) == :compressed
      return representation if representation
      return name if name
      alpha? ? rgba_str(opts) : hex_str
    end
    ...
    def rgba_str
      split = Thread.current.thread_variable_get(:style) == :compressed ? ',' : ', '
